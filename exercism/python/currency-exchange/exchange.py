...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    """
    total = budget/(exchange_rate + ((exchange_rate/100)*spread))
    total = int(total/denomination)
...
def unexchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    total = budget/(exchange_rate + ((exchange_rate/100)*spread))
    amount = int(total/denomination)
    amount_denomionation = amount * denomination
    return int(total - amount_denomionation)
